        ...
        <div class="panel-body">
            <form action="" method="get" class="form-horizontal" id="myform" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                        <select class="select valid" name="condition" id="condition" size="1" style="width: 150px;" aria-invalid="false">
                            <option value="0" <?php  if($cj_pre_prize_data['condition']==0) { ?>selected="selected"<?php  } ?>>无</option>
                            <option value="1" <?php  if($cj_pre_prize_data['condition']==1) { ?>selected="selected"<?php  } ?>>男</option>
                            <option value="2" <?php  if($cj_pre_prize_data['condition']==2) { ?>selected="selected"<?php  } ?>>女</option>
                        </select>
                    </div>
                </div>
