<?php defined('IN_IA') or exit('Access Denied');?><div class="panel panel-success">
    ...
    <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                        <input class="form-control" name="height_price" value="<?php  echo $height_price['value'];?>" type="number" min="0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                        <input class="form-control" name="home_price1" value="<?php  echo $home_price1['value'];?>" type="number" min="0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                        <input class="form-control" name="home_price2" value="<?php  echo $home_price2['value'];?>" type="number" min="0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                        <input class="form-control" name="home_price3" value="<?php  echo $home_price3['value'];?>" type="number" min="0">
