...
<div class="main">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form action="<?php  echo $this->createWeburl('program');?>" method="post" class="form-horizontal" id="myform">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">点击获取幸运币:</label>
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">小程序头像:</label>
                    <div class="col-sm-7 col-lg-8 col-md-8 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="" >
                        <input type="hidden" name="opp" value="add">
