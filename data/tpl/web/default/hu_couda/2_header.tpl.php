...
<head>
    ...
    <?php  if($_GPC['do']!='add' && $_GPC['do']!='ad_mng') { ?>
                        ...
                        <div class="left-menu-content">
                            ...
                            <div class="panel panel-menu">
                                ...
                                <div class="panel-heading">
                                    <span class="" data-toggle="collapse" <?php  if($frame_section['title'] !='业务菜单') { ?>data-target="#frame-<?php  echo $frame_section_id;?>" onclick="util.cookie.set('menu_fold_tag:<?php  echo $frame_section_id;?>', util.cookie.get('menu_fold_tag:<?php  echo $frame_section_id;?>') == 1 ? 0 : 1)"<?php  } ?>><?php  echo $frame_section['title'];?><i class="wi wi-down-sign-s pull-right"></i></span>
                                </div>
                                <?php  } ?>
                                <ul class="list-group collapse <?php  if($_GPC['menu_fold_tag:'.$frame_section_id] == 0) { ?>in<?php  } ?>" id="frame-<?php  echo $frame_section_id;?>" <?php  if($frame_section['title'] =='业务菜单') { ?>style="height: 500px;"<?php  } ?>>
                                    ...
                                    <?php  } else if(($menu_id != 'platform_module_permissions' && (strpos($menu['title'], 'todo') === false || $_W['user']['type'] == 0))) { ?>
