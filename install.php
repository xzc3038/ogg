		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="http://wx.hzweb.top">趣味淘</a></li>
					<li role="presentation"><a href="http://wx.hzweb.top">趣味淘</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://wx.hzweb.top">关于趣味淘</a> &nbsp; &nbsp; <a href="http://wx.hzweb.top">趣味淘</a> &nbsp; &nbsp; <a href="http://www.we7.cc">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.wx.hzweb.top"><b>趣味淘</b></a>  &copy; 2018 <a href="http://wx.hzweb.top">wx.hzweb.top</a>
				</div>
			</div>
		</div>
